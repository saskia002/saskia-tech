...
-- CreateIndex
CREATE UNIQUE INDEX "Category_code_key" ON "blog"."Category"("code");
...
-- AddForeignKey
ALTER TABLE "blog"."Post" ADD CONSTRAINT "Post_categoryCode_fkey" FOREIGN KEY ("categoryCode") REFERENCES "blog"."Category"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
